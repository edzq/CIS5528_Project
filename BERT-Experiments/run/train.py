...
class Trainer(object):
    ...
    def train(self, cfg, train_loader, valid_loader):
        ...
        for epoch in range(cfg.epochs):
            ...
            total_loss = 0.0
            total_setps = 0
            for step, batch in tqdm(enumerate(train_loader), desc=f'Training epoch [{epoch}/{cfg.epochs}]', mininterval=0.5, colour='red', leave=False, file=sys.stdout):
