...
def get_args():
    ...
    parser.add_argument('--dataset', default='NCBI', choices=['BC2GM', 'BC5CDR-chem', 'NCBI', 'BC5CDR-disease'], type=str)
    ...
    parser.add_argument('--train_batch_size', default=16, type=int, help='batch size of training')
    parser.add_argument('--eval_batch_size', default=16, type=int, help='batch size of evaluating')
    ...
    parser.add_argument('--bert_type', default='BERT', choices=['BERT', 'RoBERTa', 'ALBERT', 'ELECTRA'], type=str)
    parser.add_argument('--bert_name', default='PubMedBERT', choices=['PubMedBERT', 'bert-base-cased', 'bert-base-uncased', 'scibert_scivocab_cased', 'scibert_scivocab_uncased', 'biobert-v1.1'], type=str, help='bert name of the selected bert_type')
    ...
    parser.add_argument('--crf_learning_rate', default=5e-03)
...
def main():
    ...
    train_examples = ner_processor.get_examples(os.path.join(args.input, 'train.jsonl'), data_type='train')
    
    train_examples = train_examples[:250]
    # train_examples = train_examples[:int(len(train_examples) * 0.9 )]
