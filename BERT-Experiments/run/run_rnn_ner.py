...
from tools.dataset import NerDataset, ner_collate_fn, build_vocab
from tools.log_util import build_logger
from models.rnn_ner import RNNNER
from layers.pretrained_embedding import PretrainedEmbedding
...
def get_args():
    ...
    parser.add_argument('--dataset', default='DMDD', choices=['conll', 'clue', 'ontonotes4', 'ontonotes5'], type=str)
